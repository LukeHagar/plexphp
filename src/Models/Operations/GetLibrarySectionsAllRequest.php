...
class GetLibrarySectionsAllRequest
{
     ...
     *
     *
     * @var GetLibrarySectionsAllQueryParamType $type
     */
     ...
     *
     *
     * @var ?GetLibrarySectionsAllQueryParamIncludeMeta $includeMeta
     */
    #[SpeakeasyMetadata('queryParam:style=form,explode=true,name=includeMeta')]
    public ?GetLibrarySectionsAllQueryParamIncludeMeta $includeMeta = null;
     ...
     * @param  GetLibrarySectionsAllQueryParamType  $type
     * @param  ?GetLibrarySectionsAllQueryParamIncludeMeta  $includeMeta
