...
class GetResizedPhotoRequest
{
     ...
     * @param  ?string  $url
     */
    public function __construct(?float $width = null, ?float $height = null, ?int $opacity = null, ?float $blur = null, ?MinSize $minSize = null, ?Upscale $upscale = null, ?string $url = null)
    {
        $this->width = $width;
        $this->height = $height;
