...
class GetLibrarySectionsAllPart
{
     ...
     *
     * @var ?array<GetLibrarySectionsAllStream> $stream
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('Stream')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\LukeHagar\Plex_API\Models\Operations\GetLibrarySectionsAllStream>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?array $stream = null;

    /**
     *
     * @var ?GetLibrarySectionsAllHasThumbnail $hasThumbnail
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('hasThumbnail')]
    #[\Speakeasy\Serializer\Annotation\Type('\LukeHagar\Plex_API\Models\Operations\GetLibrarySectionsAllHasThumbnail|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?GetLibrarySectionsAllHasThumbnail $hasThumbnail = null;
