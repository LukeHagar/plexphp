...
class GetSearchAllLibrariesMedia
{
    ...
    #[\JMS\Serializer\Annotation\Type('\LukeHagar\Plex_API\Models\Operations\GetSearchAllLibrariesOptimizedForStreaming|null')]
    #[\JMS\Serializer\Annotation\SkipWhenNull]
    ...
    #[\JMS\Serializer\Annotation\Type('array<\LukeHagar\Plex_API\Models\Operations\GetSearchAllLibrariesPart>')]
    public array $part;
     ...
     */
    public function __construct(int $id, string $container, array $part, ?int $duration = null, ?int $bitrate = null, ?int $width = null, ?int $height = null, ?float $aspectRatio = null, ?string $audioProfile = null, ?int $audioChannels = null, ?string $audioCodec = null, ?string $videoCodec = null, ?string $videoResolution = null, ?string $videoFrameRate = null, ?string $videoProfile = null, ?bool $hasVoiceActivity = null, ?GetSearchAllLibrariesOptimizedForStreaming $optimizedForStreaming = null, ?bool $has64bitOffsets = null)
    {
        $this->id = $id;
