...
class GetAllMediaLibraryPart
{
     ...
     *
     * @var GetAllMediaLibraryOptimizedForStreaming1|bool|null $optimizedForStreaming
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('optimizedForStreaming')]
    #[\Speakeasy\Serializer\Annotation\Type('\LukeHagar\Plex_API\Models\Operations\GetAllMediaLibraryOptimizedForStreaming1|bool|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public GetAllMediaLibraryOptimizedForStreaming1|bool|null $optimizedForStreaming = null;

    /**
     * An array of streams for this part.
     *
     * @var ?array<GetAllMediaLibraryStream> $stream
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('Stream')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\LukeHagar\Plex_API\Models\Operations\GetAllMediaLibraryStream>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?array $stream = null;

    /**
     *
     * @var ?GetAllMediaLibraryHasThumbnail $hasThumbnail
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('hasThumbnail')]
    #[\Speakeasy\Serializer\Annotation\Type('\LukeHagar\Plex_API\Models\Operations\GetAllMediaLibraryHasThumbnail|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?GetAllMediaLibraryHasThumbnail $hasThumbnail = null;
     ...
     * @param  GetAllMediaLibraryOptimizedForStreaming1|bool|null  $optimizedForStreaming
     * @param  ?GetAllMediaLibraryHasThumbnail  $hasThumbnail
     * @param  ?array<GetAllMediaLibraryStream>  $stream
     * @phpstan-pure
     */
