...
class GetSearchAllLibrariesMetadata
{
     ...
     * $guids
     *
     * @var ?array<GetSearchAllLibrariesGuids> $guids
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('Guid')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\LukeHagar\Plex_API\Models\Operations\GetSearchAllLibrariesGuids>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  ?array<GetSearchAllLibrariesGuids>  $guids
     ...
     * @phpstan-pure
     */
    public function __construct(string $ratingKey, string $key, string $guid, string $slug, GetSearchAllLibrariesType $type, string $title, string $banner, string $titleSort, string $summary, float $rating, float $audienceRating, string $tagline, string $thumb, string $art, string $theme, int $index, int $childCount, int $seasonCount, int $duration, int $addedAt, ?string $studio = null, ?string $contentRating = null, ?int $year = null, ?int $leafCount = null, ?int $viewedLeafCount = null, ?LocalDate $originallyAvailableAt = null, ?int $updatedAt = null, ?int $parentYear = null, ?string $audienceRatingImage = null, ?string $chapterSource = null, ?string $primaryExtraKey = null, ?string $originalTitle = null, ?string $parentRatingKey = null, ?string $grandparentRatingKey = null, ?string $parentGuid = null, ?string $grandparentGuid = null, ?string $grandparentSlug = null, ?string $grandparentKey = null, ?string $parentKey = null, ?string $grandparentTitle = null, ?string $grandparentThumb = null, ?string $grandparentTheme = null, ?string $grandparentArt = null, ?string $parentTitle = null, ?int $parentIndex = null, ?string $parentThumb = null, ?string $ratingImage = null, ?int $viewCount = null, ?int $viewOffset = null, ?int $skipCount = null, ?string $subtype = null, ?int $lastRatedAt = null, ?string $createdAtAccuracy = null, ?string $createdAtTZOffset = null, ?int $lastViewedAt = null, ?float $userRating = null, ?array $image = null, ?GetSearchAllLibrariesUltraBlurColors $ultraBlurColors = null, ?array $guids = null, ?int $librarySectionID = null, ?string $librarySectionTitle = null, ?string $librarySectionKey = null, ?GetSearchAllLibrariesShowOrdering $showOrdering = null, ?GetSearchAllLibrariesFlattenSeasons $flattenSeasons = null, ?bool $skipChildren = null, ?array $media = null, ?array $genre = null, ?array $country = null, ?array $director = null, ?array $writer = null, ?array $role = null, ?array $location = null)
    {
