 ...
 * @access public
 */
class GetServerCapabilitiesServerResponseBody
{
    /**
     * $errors
     * 
     * @var ?array<\LukeHagar\Plex_API\Models\Operations\Errors> $errors
     */
	#[\JMS\Serializer\Annotation\SerializedName('errors')]
    #[\JMS\Serializer\Annotation\Type('array<LukeHagar\Plex_API\Models\Operations\Errors>')]
