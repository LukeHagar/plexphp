...
class GetLibrariesResponseBody
{
     ...
     * $errors
     *
     * @var ?array<GetLibrariesErrors> $errors
     */
    #[\JMS\Serializer\Annotation\SerializedName('errors')]
    #[\JMS\Serializer\Annotation\Type('array<\LukeHagar\Plex_API\Models\Errors\GetLibrariesErrors>')]
    ...
    /**
     * @param  ?array<GetLibrariesErrors>  $errors
