...
class GetRecentlyAddedLibraryBadRequest
{
    ...
    #[\Speakeasy\Serializer\Annotation\Type('array<\LukeHagar\Plex_API\Models\Errors\GetRecentlyAddedLibraryErrors>|null')]
    ...
    public function toException(): GetRecentlyAddedLibraryBadRequestThrowable
    {
        ...
        return new GetRecentlyAddedLibraryBadRequestThrowable($message, (int) $code, $this);
    }
}