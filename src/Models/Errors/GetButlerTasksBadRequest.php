...
class GetButlerTasksBadRequest
{
    /**
     * $errors
     *
    ...
    /**
     * @param  ?array<GetButlerTasksErrors>  $errors
    ...
    public function toException(): GetButlerTasksBadRequestThrowable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new GetButlerTasksBadRequestThrowable($message, (int) $code, $this);
    }
}