...
class GetButlerTasksUnauthorized
{
    /**
     * $errors
     *
    ...
    /**
     * @param  ?array<GetButlerTasksButlerErrors>  $errors
    ...
    public function toException(): GetButlerTasksUnauthorizedThrowable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new GetButlerTasksUnauthorizedThrowable($message, (int) $code, $this);
    }
}