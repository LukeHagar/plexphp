...
class GetServerIdentityResponseBody
{
     ...
     * $errors
     *
     * @var ?array<GetServerIdentityErrors> $errors
     */
    #[\JMS\Serializer\Annotation\SerializedName('errors')]
    #[\JMS\Serializer\Annotation\Type('array<\LukeHagar\Plex_API\Models\Errors\GetServerIdentityErrors>')]
    ...
    /**
     * @param  ?array<GetServerIdentityErrors>  $errors
