...
class RefreshLibraryResponseBody
{
     ...
     * $errors
     *
     * @var ?array<RefreshLibraryErrors> $errors
     */
    #[\JMS\Serializer\Annotation\SerializedName('errors')]
    #[\JMS\Serializer\Annotation\Type('array<\LukeHagar\Plex_API\Models\Errors\RefreshLibraryErrors>')]
    ...
    /**
     * @param  ?array<RefreshLibraryErrors>  $errors
