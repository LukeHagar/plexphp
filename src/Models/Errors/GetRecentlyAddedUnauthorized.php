...
class GetRecentlyAddedUnauthorized
{
     ...
     * $errors
     *
     * @var ?array<GetRecentlyAddedLibraryErrors> $errors
     */
    #[\JMS\Serializer\Annotation\SerializedName('errors')]
    #[\JMS\Serializer\Annotation\Type('array<\LukeHagar\Plex_API\Models\Errors\GetRecentlyAddedLibraryErrors>|null')]
    ...
    /**
     * @param  ?array<GetRecentlyAddedLibraryErrors>  $errors
    ...
    public function toException(): GetRecentlyAddedUnauthorizedThrowable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new GetRecentlyAddedUnauthorizedThrowable($message, (int) $code, $this);
    }
}