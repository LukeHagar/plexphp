...
class GetLibraryResponseBody
{
     ...
     * $errors
     *
     * @var ?array<GetLibraryErrors> $errors
     */
    #[\JMS\Serializer\Annotation\SerializedName('errors')]
    #[\JMS\Serializer\Annotation\Type('array<\LukeHagar\Plex_API\Models\Errors\GetLibraryErrors>')]
    ...
    /**
     * @param  ?array<GetLibraryErrors>  $errors
