...
class GetBannerImageUnauthorized
{
    ...
    /**
     * @param  ?array<GetBannerImageMediaErrors>  $errors
    ...
    public function toException(): GetBannerImageUnauthorizedThrowable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new GetBannerImageUnauthorizedThrowable($message, (int) $code, $this);
    }
}